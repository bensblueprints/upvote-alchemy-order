...
export const Support = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: 'Failed to send support request. Please try again or contact us directly.',
        variant: 'destructive',
      });
    } finally {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Need help? We're here to assist you with any questions or issues.</p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">support@upvotethat.com</p>
              </div>
            </CardContent>
          </Card>
